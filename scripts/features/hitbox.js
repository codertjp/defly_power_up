...
function loadHitboxes() {
  ...
  PRfactor = initPRimg / window.devicePixelRatio;
  `
<div id="hitboxLine" style="background-image: url(https://codertjp.com.test/image/hitBoxLine.png); background-size: cover; width: ${
    100 * PRfactor
  }px; height: ${
    100 * PRfactor
  }px; position: absolute; z-index: 10000; top: 50%; left: 50%; transform: translate(-50%, -50%); touch-action: none; pointer-events: none;"></div>
<div id="hitboxBullet" style="background-image: url(https://codertjp.com.test/image/hitBox.png); background-size: cover; width: ${
    36 * PRfactor
  }px; height: ${
    36 * PRfactor
  }px; position: absolute; z-index: 10000; top: 50%; left: 50%; transform: translate(-50%, -50%); touch-action: none; pointer-events: none;"></div>
<div id="hitboxWall" style="filter: invert(1); background-image: url(https://codertjp.com.test/image/hitBox.png); background-size: cover; width: ${
    20 * PRfactor
  }px; height: ${
    20 * PRfactor
  }px; position: absolute; z-index: 10000; top: 50%; left: 50%; transform: translate(-50%, -50%); touch-action: none; pointer-events: none;"></div>
